...
#define USBD_SIZE_REPORT_DESC        63
#define USBD_SIZE_STRING_LANGID      4
#define USBD_SIZE_STRING_SERIAL      22
#define CUSTOM_HID_BINTERVAL         0x0A //§£§Ù§ñ§Ý §ä§Ñ§Ü§à§Û §Ø§Ö, §Ü§Ñ§Ü §ß§Ñ §Þ§à§Ö§Û §Ü§Ý§Ñ§Ó§Ú§Ñ§ä§å§â§Ö

#define USBD_VID                     2323
#define USBD_PID                     78352
